...
{
	public class WebHookHandlers : CommonInterface, IWebHookHandlers
	{
		public WebHookHandlers(ILoggerStore logger) : base(logger, nameof(WebHookHandlers))
		{
		}

		public void StripeHandler(string json)
		{
