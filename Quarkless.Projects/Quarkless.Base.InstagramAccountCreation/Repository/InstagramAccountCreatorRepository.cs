...
using Quarkless.Base.InstagramAccountCreation.Models;
using Quarkless.Base.InstagramAccountCreation.Models.Interfaces;
using Quarkless.Repository.MongoContext;

namespace Quarkless.Base.InstagramAccountCreation.Repository
{
