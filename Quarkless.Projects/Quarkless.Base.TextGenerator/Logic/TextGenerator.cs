...
namespace Quarkless.Base.TextGenerator.Logic
{
	//TODO ADD AI LATER, FOR NOW JUST USING MARKOV ALGO

	public class TextGenerator : ITextGenerator
	{
		private const string EMOJI_LIST =
@"Positive:😂😍👏🔥🎉💯
Smileys:😀😁😂🤣😃😄😅😆😉😊😋😎😍😘🥰😗😙😚🙂🤗🤩🤔🤨🙄😏😮😛😜😝🤤🤑🤪😵😇🤠🥴🧐🤓👻👽🤖😺😸😹😻😼😽🙀
People and Fantasy:👶👧🧒👦👩🧑👨👵🧓👴👲💋‍👩❤️‍🤲👐🙌👏🤝👍👊✊🤛🤜🤞🤟🤘👌👈👉👆👇☝️✋🤚🖐🖖👋🤙💪
...
Symbols:❤️🧡💛💚💙💜🖤❣️💕💞💓💗💖💘💝💟💯";
		...
		public string GenerateSingleEmoji(EmojiType set)
		{
			var typeEmoji = _emojiDict[set];
			var results = string.Empty;
			var xRandom = SecureRandom.Next(0, (typeEmoji.Length/2) - 2);
			if (xRandom % 2 != 0) xRandom += 1;
			results += typeEmoji.Substring(xRandom, 2);
			return results;
		}
