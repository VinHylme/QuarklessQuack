...
{
	public class InstagramSmsService : ISmsService
	{	
		private const int MAX_NUMBER_USAGE = 2;
		...
		private readonly SmsHandler.Logic.SmsService _smsService;
		private readonly CountryCode _countryCode;
		public InstagramSmsService(CountryCode countryCode)
		{
			_countryCode = countryCode;
			if (!TotalInstancesPerNumber.ContainsKey(_countryCode))
				TotalInstancesPerNumber.Add(_countryCode, 0);
			
			_smsService = new SmsHandler.Logic.SmsService(SmsServiceType.Instagram, _countryCode);
