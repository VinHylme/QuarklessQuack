...
using Quarkless.Base.PuppeteerClient.Models.Extensions;
...
namespace Quarkless.Base.ContentSearch.Logic
{
	public class YandexImageSearch : IYandexImageSearch
	{
		...
		{
			_restSharpClientManager = new RestSharpClientManager.Logic.RestSharpClientManager();
		...
		public async Task<SearchResponse<Quarkless.Models.SearchResponse.Media>> QuerySimilarImages(IEnumerable<GroupImagesAlike> similarImages, int pageLimit)
		{
			var response = new SearchResponse<Quarkless.Models.SearchResponse.Media>();
			var totalFound = new Quarkless.Models.SearchResponse.Media();
			try
			{
				{
		...
		public async Task<SearchResponse<Quarkless.Models.SearchResponse.Media>> QueryImages(YandexSearchQuery query, int pageLimit = 1)
		{
			var response = new SearchResponse<Quarkless.Models.SearchResponse.Media>();
			var totalFound = new Quarkless.Models.SearchResponse.Media();
