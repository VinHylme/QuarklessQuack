...
namespace Quarkless.Base.InstagramSearch.Logic
{
	public class InstagramContentSearch : IInstagramContentSearch
	{
		...
		public async Task<Quarkless.Models.SearchResponse.Media> SearchMediaDetailInstagram(IEnumerable<CTopic> topics, int limit, bool isRecent = false)
		{
			var medias = new Quarkless.Models.SearchResponse.Media();
		...
		public async Task<Quarkless.Models.SearchResponse.Media> SearchMediaDetailInstagram(IEnumerable<string> topics, int limit, bool isRecent = false)
		{
			var medias = new Quarkless.Models.SearchResponse.Media();
			foreach (var topic in topics)
			{
		...
		public async Task<Quarkless.Models.SearchResponse.Media> SearchUsersMediaDetailInstagram(CTopic topic, string userName, int limit)
		{
		...
		public async Task<Quarkless.Models.SearchResponse.Media> SearchTopLocationMediaDetailInstagram(Location location, int limit)
		{
		...
		public async Task<Quarkless.Models.SearchResponse.Media> SearchRecentLocationMediaDetailInstagram(Location location, int limit)
		{
			var locationResult = await _responseResolver
				.WithClient(_container)
				.WithAttempts(1)
		...
		public async Task<Quarkless.Models.SearchResponse.Media> SearchUserFeedMediaDetailInstagram(string[] seenMedias = null, bool requestRefresh = false, int limit = 1)
		{
			var medias = new Quarkless.Models.SearchResponse.Media();
