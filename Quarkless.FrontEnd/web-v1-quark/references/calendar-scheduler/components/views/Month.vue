<template>
    <section class="v-cal-content">
        <div class="v-cal-weekdays">
            <div class="v-cal-weekday-item" v-for="weekday in weekdays" v-bind:key="weekday">{{ weekday }}</div>
        </div>
        <div class="v-cal-days" v-for="row in calendar" v-bind:key="row">
            ...
            <div :ref="'days.day_' + day.d.format('DDD')" class="v-cal-day v-cal-day--month"
                 ...
                 'is-different-month': day.isDifferentMonth }" v-for="day in row" :key="day">
