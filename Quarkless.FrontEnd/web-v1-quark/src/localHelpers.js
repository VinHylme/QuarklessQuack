...
function GetUserDetails(){
    return new Promise((resolve,reject)=>{
        ...
        GetUserBrowser().then(b=>{
            const comp = b.components;
            response.deviceDetails.uniqueId = b.uniqueId
            ...
            response.deviceDetails.plugins = comp[17].value
