...
import { ValidateUrl, UUIDV4 } from '../../helpers'
import vue from 'vue';
export default {
    components: {
        UserResults,
    ...
    methods: {
        ...
        MapType(e) {
            ...
            switch (e) {
                case 1:
                    return { index: 1, name: 'GetUserFollowingList' }
                case 2:
                    return { index: 2, name: 'GetUserFollowerList' }
                case 3:
                    return { index: 3, name: 'GetUserTargetLocation' }
                case 4:
                    return { index: 4, name: 'GetUsersTargetList' }
                case 5:
                    return { index: 5, name: 'GetUserFollowingSuggestionList' }
                case 6:
                    return { index: 6, name: undefined }
                case 7:
                    return { index: 7, name: undefined }
                case 8:
                    return { index: 8, name: undefined }
            }
        },
        SelectSection(s) {
            if (s !== undefined) {
...
.recent-comment-container {
    display: flex;
    flex-direction: row;
    /* let the content flow to the next row */
...
.section-container {
    ...
    .chat-side-panel {
        ...
        .chat-column {
            ...
            .user-item {
                padding-left: 1.6em; //margin-bottom:.5em;
                // margin-top:.5em;
                background: #191919;
                width: 100%;
                height: 100px;
        ...
        .menu {
            ...
            .menu-list {
                ...
                a {
                    ...
                    color: #d9d9d9;
                    &:hover {
                        background: #232323; //border-radius: 2em;
                    }
                    &.is-active {
                        // border-radius:2em;
